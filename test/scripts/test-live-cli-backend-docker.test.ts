...
it("validates setup early and forwards argument overrides into Docker", () => {
  ...
  // oxfmt-ignore
  const controls = "OPENCLAW_LIVE_CLI_BACKEND_ARGS OPENCLAW_LIVE_CLI_BACKEND_RESUME_ARGS OPENCLAW_TEST_CONSOLE OPENCLAW_LIVE_CLI_BACKEND_CACHE_PROBE OPENCLAW_LIVE_CLI_BACKEND_ADVISORY OPENCLAW_LIVE_CLI_BACKEND_ALLOW_PROVIDER_SKIP".split(" ");
